                    ...
                    <div class="container" id="homeContainer">
                        <div className="row">
                            <div className="col-lg-6 col-md-12 col-sm-12">
                                <h1 class="anton-regular text-center">Hey, I am <span>Harpreet</span>,<br></br> <span className='fs-5'>a <span> <em>Front-end  Developer </em></span></span> </h1>
                            </div>
                        </div>

                        <div className="row py-3">
                            <div className="col-lg-6 col-md-6 col-sm-12 my-2">
                            <p class="text-secondary mx-3 fs-sm-1 fs-md-2">I am a self-motivated front-end developer, who is keen about learning web technologies. I am passionate about learning and always try to better my self at learning with every day passing by. </p>
                        </div>
                        
                            <div className="col-lg-6 col-md-6 col-sm-12">
                                 <div id="imageContainer" className=''></div>
